...
$q=mysqli_query($con,"SELECT * FROM chemical.notices WHERE notype='cdpc' order by id ");
?>
...
<thead >
         ...
         <td class="theading" width="50%"><font color="grey">Title</font></td>
          <td class="theading" width="20%"><font color="grey">Posted by</font></td>
        ...
        <td class="theading" width="20%"><font color="grey">Time</font></td>
         ...
         <td><span class="badge badge-warning"><?php echo $row["from"]; ?></span></td>
