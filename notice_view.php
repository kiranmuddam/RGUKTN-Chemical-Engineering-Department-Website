...
$result=mysqli_query($con,"select * from chemical.notices where id='".$id."'");
...
if($row["attachment"]!="--")
			{
				$file_name=$row['attachment'];
				 $files.="<a href='admin/upload/".$file_name."' target=_blank style='font-size:15px;text-decoration:underline;color:#787878;'><img src='images/index4.jpg' style='width:30px;height:30px;' /> ".$file_name."</a><br />";
}			
