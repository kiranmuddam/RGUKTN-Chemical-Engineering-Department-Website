            ...
            <div class="header-main container">
                ...
                <div class="info col-md-8 col-sm-8">
                    <ul class="menu-top navbar-right ">
                        <li class="divider"><a href="index.php"><b>user</b></a></li>
                                                <li class="divider"><a href="password_form.php"><b>Change Password</b></a></li>
            ...
            <div class="top-bar  hidden-xs">
                <div class="container">              
                   ...
                   $date=date("j m Y");
                    ...
                    while($m=mysqli_fetch_array($q,MYSQLI_BOTH)){
                        $notice_r=$m['title'];
                    }
                    ?>
                    <h6 class="fontSize hidden-xs " style="float:left;margin-top:10px;padding:0px;height:0px;width:55%;"><marquee style="margin-top:10px;" behavior="infinite" direction="left" scrollamount="5" onmouseover="this.stop();" onmouseout="this.start();"><span class="fa fa-flash">&nbsp;Latest Notifiaction: &nbsp;<?php echo $notice_r ?><img src="assets/images/new1.gif" width="30" height="25"></marquee></span></h6> 
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="about-department"><i class="fa fa-info-circle" aria-hidden="true"></i>
                             
                            &nbsp;&nbsp;About Department</a></li>
                                <li><a href="infrastructure">
                                <i class="fa fa-qrcode" aria-hidden="true"></i>&nbsp;&nbsp;Infrastructure</a></li>
                                <li><a href="faculty"><i class="fa fa-user-circle-o" aria-hidden="true"></i>&nbsp;&nbsp;Faculty</a></li> 
                                <li><a href="chemical.php"><i class="fa fa-flask" aria-hidden="true"></i>&nbsp;&nbsp;About Chemical Engineering</a></li> 
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="current-students">
                                    <i class="fa fa-male" aria-hidden="true"></i>&nbsp;&nbsp;Current Students</a></li>   
                        ...
                        <li class="nav-item"><a href="gallery">
                            <i class="fa fa-picture-o" aria-hidden="true"></i>&nbsp;&nbsp;Gallery</a></li>
                    </ul><!--//nav-->
                </div><!--//navabr-collapse-->
            </div><!--//container-->
        </nav><!--//main-nav-->
